...
read_pages = int(input('Enter the number of tha pages that you read today: ')) # შევქმენი read_pages ცვლადი რომელიც ინახავს მომხმარებლის მიერ წაკითხული გვერდების რაოდენობას
free_time = bool(input('Did you have free time today?: '))  # შევქმენი free_time ცვლადი რომელიც ინახავს ჰქონდა თუ არა მომხმარებელს თავისუფალი დრო
...
print('Results: The fact that you are productive is ' + str(productive) )
