...
print('Hi ' + first_name + ' ' + last_name + '!.  you are ' + age + ' years old. we will physics teacher for your age who will be able to teach you in ' + town + 'finding the teacher may take 3 days.' )
